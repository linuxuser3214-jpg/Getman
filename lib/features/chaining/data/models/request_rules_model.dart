...
/// typeId 9. One per request config id; stored in its own box keyed by configId.
@HiveType(typeId: 9)
class RequestRulesModel extends HiveObject {
  ...
  factory RequestRulesModel.fromEntity(RequestRulesEntity e) => RequestRulesModel(
        configId: e.configId,
        extractionRules: e.extractionRules.map(ExtractionRuleModel.fromEntity).toList(),
