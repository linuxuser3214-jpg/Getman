...
ThemeData brutalistTheme(
  ...
  final surface = isDark
      ? BrutalistPalette.surfaceDark
      : BrutalistPalette.surfaceLight;
  final text = isDark ? BrutalistPalette.textDark : BrutalistPalette.textLight;
  final border = isDark
      ? BrutalistPalette.borderDark
      : BrutalistPalette.borderLight;
  final currentPrimary = isDark
      ? BrutalistPalette.primaryDark
  ...
  final palette = AppPalette(
    ...
    variableResolved: isDark
        ? BrutalistPalette.variableResolvedDark
        : BrutalistPalette.variableResolved,
    variableUnresolved: isDark
        ? BrutalistPalette.variableUnresolvedDark
        : BrutalistPalette.variableUnresolved,
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style:
          ElevatedButton.styleFrom(
            ...
            // Intentionally responsive via AppLayout (was const 14
            // pre-refactor).
            textStyle: TextStyle(
              fontSize: layout.fontSizeTitle,
              fontWeight: FontWeight.w900,
              color: BrutalistPalette.textLight,
            ),
          ).copyWith(
  ...
  return base.copyWith(
    extensions: [
      ...
      brutalistComponents(reduceEffects: reduceEffects),
    ],
  );
}
