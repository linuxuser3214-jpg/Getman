...
void main() {
  ...
  test('a mirror failure logs once per root, then quiets until recovery', () async {
    final failures = <String>[];
    final original = debugPrint;
    debugPrint = (String? message, {int? wrapWidth}) {
      if (message != null && message.contains('Workspace mirror failed')) failures.add(message);
    };
