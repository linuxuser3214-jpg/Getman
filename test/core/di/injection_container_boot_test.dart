...
void main() {
  ...
  setUp(() async {
    ...
    if (!Hive.isAdapterRegistered(6)) Hive.registerAdapter(StoredCookieModelAdapter());
    if (!Hive.isAdapterRegistered(7)) Hive.registerAdapter(ExtractionRuleModelAdapter());
    if (!Hive.isAdapterRegistered(8)) Hive.registerAdapter(AssertionModelAdapter());
    if (!Hive.isAdapterRegistered(9)) Hive.registerAdapter(RequestRulesModelAdapter());
  });
  ...
  test('opens both deferred boxes and hydrates the jar from a cold (closed) state', () async {
